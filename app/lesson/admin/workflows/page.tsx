...
import { approvalWorkflows as initialWorkflows } from "@/lib/mock-data-lesson"
import type { ApprovalWorkflow, ApprovalStep } from "@/lib/mock-data-lesson"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">审批流程管理</h1>
            <p className="text-muted-foreground mt-1">预设审批流模板，供批次关联使用</p>
          </div>
