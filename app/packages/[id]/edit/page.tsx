...
import { packages, featureModules, aiModels } from "@/lib/mock-data"
  ...
  useEffect(() => {
    ...
    if (pkg) {
      setFormData({
        name: pkg.name,
        code: pkg.code,
        aiModel: pkg.quotas.aiModel,
        dailyTokenLimit: pkg.quotas.dailyTokenLimit.toString(),
        maxStudentAccounts: pkg.quotas.maxStudentAccounts.toString(),
        maxTeacherAccounts: pkg.quotas.maxTeacherAccounts.toString(),
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">编辑套餐</h1>
            <p className="text-sm text-muted-foreground">
              修改套餐 {formData.name} 的配置信息
            </p>
          </div>
        </div>
