...
-- PART 3: 添加 FK 约束
ALTER TABLE batches ADD CONSTRAINT IF NOT EXISTS fk_batches_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE position_recommendations ADD CONSTRAINT IF NOT EXISTS fk_position_recommendations_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE courses ADD CONSTRAINT IF NOT EXISTS fk_courses_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE lesson_batches ADD CONSTRAINT IF NOT EXISTS fk_lesson_batches_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE scene_batches ADD CONSTRAINT IF NOT EXISTS fk_scene_batches_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE evaluation_batches ADD CONSTRAINT IF NOT EXISTS fk_evaluation_batches_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE exam_usages ADD CONSTRAINT IF NOT EXISTS fk_exam_usages_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE exam_results ADD CONSTRAINT IF NOT EXISTS fk_exam_results_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE job_ability_results ADD CONSTRAINT IF NOT EXISTS fk_job_ability_results_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE certification_grade_leaderboard ADD CONSTRAINT IF NOT EXISTS fk_certification_grade_leaderboard_major FOREIGN KEY (major_id) REFERENCES majors(id) ON DELETE SET NULL;
ALTER TABLE courses ADD CONSTRAINT IF NOT EXISTS fk_courses_industry FOREIGN KEY (industry_id) REFERENCES industries(id) ON DELETE SET NULL;
