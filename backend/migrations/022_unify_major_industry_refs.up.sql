...
-- 2. batches（job 批次）
ALTER TABLE batches ADD COLUMN major_id UUID;
...
ALTER TABLE position_recommendations ADD COLUMN major_id UUID;
...
-- 4. courses（课程）
ALTER TABLE courses ADD COLUMN major_id UUID;
...
ALTER TABLE lesson_batches ADD COLUMN major_id UUID;
...
ALTER TABLE scene_batches ADD COLUMN major_id UUID;
...
ALTER TABLE evaluation_batches ADD COLUMN major_id UUID;
...
-- 8. exam_usages（考试安排）
ALTER TABLE exam_usages ADD COLUMN major_id UUID;
...
-- 9. exam_results（考试成绩）
ALTER TABLE exam_results ADD COLUMN major_id UUID;
...
ALTER TABLE job_ability_results ADD COLUMN major_id UUID;
...
ALTER TABLE certification_grade_leaderboard ADD COLUMN major_id UUID;
...
ALTER TABLE courses ADD COLUMN industry_id UUID;
...
ALTER TABLE batches DROP COLUMN major;
ALTER TABLE position_recommendations DROP COLUMN major;
ALTER TABLE courses DROP COLUMN major;
ALTER TABLE courses DROP COLUMN industry;
ALTER TABLE lesson_batches DROP COLUMN major;
ALTER TABLE scene_batches DROP COLUMN major;
ALTER TABLE evaluation_batches DROP COLUMN major;
ALTER TABLE exam_usages DROP COLUMN major;
ALTER TABLE exam_results DROP COLUMN major;
ALTER TABLE job_ability_results DROP COLUMN major;
ALTER TABLE certification_grade_leaderboard DROP COLUMN major;
